...
class Panel extends Admin_Controller {
	...
	public function admin_user()
	{
		...
		$this->mPageTitle = 'admin_users_list';
		$this->render_crud();
	}
	...
	public function admin_user_create()
	{
		...
		$this->mPageTitle = 'create_admin_user';
	...
	{
        $crud = $this->generate_multi_crud('admin_groups');	// Changed by IlChol (2017.09.13)
        $crud ->multisearch = false;				// Added by IlChol (2017.09.13)
		$this->mPageTitle = 'admin_user_groups';
		$this->render_crud();
	}
