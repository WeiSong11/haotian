	...
	<?php foreach ($menu as $parent => $parent_params): ?>
		...
		<?php if ( empty($parent_params['children']) ): ?>
			...
			<li class='<?php if ($active) echo 'active'; ?>'>
				<a href='<?php echo $parent_params['url']; ?>'>
					<i class='<?php echo $parent_params['icon']; ?>'></i> <?php echo lang($parent_params['name']); ?>
				</a>
			</li>
		...
		<?php else: ?>
			...
			<li class='treeview <?php if ($parent_active) echo 'active'; ?>'>
				<a href='#'>
					<i class='<?php echo $parent_params['icon']; ?>'></i> <span><?php echo lang($parent_params['name']); ?></span> <span class="pull-right-container"><i class='fa fa-angle-left pull-right'></i></span>
				</a>
				<ul class='treeview-menu'>
					<?php foreach ($parent_params['children'] as $name => $url): ?>
						...
						<li <?php if ($child_active) echo 'class="active"'; ?>>
							<a href='<?php echo $url; ?>'><i class='fa fa-circle-o'></i> <?php echo lang($name); ?></a>
						</li>
						<?php endif; ?>
					<?php endforeach; ?>
				</ul>
