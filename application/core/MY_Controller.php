...
class MY_Controller extends MX_Controller {
	...
	protected $mGrocery_type = '';
    	protected $mAds_sum = 0;	// Added by IlChol (2017.09.13)
	// Multilingual
	protected $mMultilingual = FALSE;
	protected $mLanguage = 'cn';
	...
	private function _setup()
	{
		...
		$this->mPageAuth = empty($config['page_auth']) ? array() : $config['page_auth'];
        	$this->mGrocery_type = empty($config['grocery_type']) ? '' : $config['grocery_type'];	// Added by IlChol (2017.09.13)
		...
		if ( !empty($lang_config) )
		{
			...
			// append to base URL
            // Commented by NickName (2017.09.11) ...
	...
	protected function render($view_file, $layout = 'default')
	{
        ...
        $this->mViewData['grocery_type'] = $this->mGrocery_type;	// Added by IlChol (2017.09.13)
        $this->mViewData['ads_sum'] = $this->mAds_sum;		// Added by IlChol (2017.09.13)
