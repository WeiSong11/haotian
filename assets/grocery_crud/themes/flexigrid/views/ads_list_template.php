        ...
        if(!$multisearch){
            ...
            <div class="sDiv quickSearchBox" id='quickSearchBox'>
                ...
                <div class="sDiv2">
                    ...
                    <!-------------------------- Edit-2 starts ------------------------------------------------------------------------------------------------------------->
                    <div style="display:none; height: 50px;" id="advanced_search_<?php echo $unique_hash; ?>">
                        <input  style="float:left;margin-right:20px" type="button" value="<?php echo $this->l('list_search');?>" class="crud_search" id='crud_search'>
                        <table>
                            <tr>
                                <?php $c=0;  foreach($columns_for_search as $column){
                                    ...
                                    $hide_tr_class = "";
                                    if( $option_type[$column->field_name] == "hidden_opts"){

                                        $type  = "numeric"; // Input type to be used
                                        $hide_tr_class ='hidden_part';
                                        //$other_class = $class = 'hidden_part';
                                    }
                                    else if( $option_type[$column->field_name] =="numeric_opts")
                                    {
                                    ...
                                    ?>
                                    <td class="<?php echo $hide_tr_class;?>" style="vertical-align: top">
                                        <!-- Field Name -->
                                        <div style="<?php if($option_type[$column->field_name] == "date_and_time"){ echo 'float:left;width:35%;';}?>"> <?php echo $column->display_as;?></div>

                                        <!-- Field Operation dropdown -->
                                        <div style="<?php if($option_type[$column->field_name] != "date_and_time"){ echo 'display:none';?><?php }?>">
                                        ...
                                        <!-- User Input field -->
                                        <div class="cell_of_<?php echo $column->field_name;?>">
                                            <!-- Single Input -->
                                            <?php if($option_type[$column->field_name] != "date_and_time") {?>
                                            <div class="<?php echo $column->field_name;?>_main">
                                                <!-- allcell data to test-->
                                                    <input style="display:block;width:80%; padding: 0px !important;-webkit-border-radius: 0px !important;border-radius:0px !important;margin-top:5px;" <?php echo (is_null($extra_attr)?"":$extra_attr); ?> class="<?php echo $other_class; ?>   allcelldata_<?php echo $unique_hash; ?>"  name="ADV_data_<?php echo $column->field_name?>" type="<?php echo $type; ?>" />
                                                <!-- end test-->
                                            </div>
                                            <?php } else {?>
                                                <div class="<?php echo $column->field_name;?>_main">
                                            ...
                                            <?php if($other_class !=""){?>
                                                ...
                                                <div style="display:none;" class="<?php echo $column->field_name;?>_sub">
                                                    <table style="margin-top:4px;">
                                                        <tr>
                                                            <td>
                                                                <input style="display:none;width:100px;" class="<?php echo $other_class?>_from  " <?php echo (is_null($extra_attr)?"":$extra_attr); ?>  name="ADV_data_<?php echo $column->field_name?>_from"/>
                                                            </td>
                                                            <td><span> &nbsp;&nbsp;To&nbsp;&nbsp;</span></td>
                                                            <td>
                                                                <input style="display:none;width:100px;" class="<?php echo $other_class?>_to  " <?php echo (is_null($extra_attr)?"":$extra_attr); ?>  name="ADV_data_<?php echo $column->field_name?>_to"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
...
// Datetimepicker for range selection
                        ...
                        $(adv_id+" .option_selection_common").change();
                        ...
                        if($(adv_id+".option_selection_common").value == "BETWEEN")
                        {
...
// Datetimepicker for range selection
        ...
        <div class="pDiv">
            ...
            <div>
                <p style="margin-top:2px"><?php echo $this->l('total_price');?> <span id="ads_sum_price"><?php echo $sumprice;?> </span></p>
            </div>
